...
def C2239_Override_041_12(testrail_run_id):
    ...
    print("raised event: ", bpnode_event, "\n terminal amount value found: ", bpnode_transaction_history, "\nSAF queue: ", bpnode_saf)
    if "No Response" in bpsim_out and ("unknown terminal" in bpnode_event and '33' in bpnode_transaction_history and bpnode_saf is None):
